% Temperature and Interface Comparison: 330¡ÆC vs 500¡ÆC (Sharp vs Gradient)
% This script compares 4 cases:
% 1. 330¡ÆC Sharp Interface
% 2. 330¡ÆC Gradient Interface
% 3. 500¡ÆC Sharp Interface
% 4. 500¡ÆC Gradient Interface
...
T1 = 330 + 273.15;  % 330¡ÆC to K (603.15 K)
T2 = 500 + 273.15;  % 500¡ÆC to K (773.15 K)
...
fprintf('330¡ÆC: D_Ni = %.2e m©÷/s, D_Ti = %.2e m©÷/s, Ratio = %.1f\n', DNi_330, DTi_330, DNi_330/DTi_330);
fprintf('500¡ÆC: D_Ni = %.2e m©÷/s, D_Ti = %.2e m©÷/s, Ratio = %.1f\n', DNi_500, DTi_500, DNi_500/DTi_500);
...
fprintf('Sharp Interface (500¡ÆC/330¡ÆC):    %.2f\n', diffused_500_sharp/diffused_330_sharp);
fprintf('Gradient Interface (500¡ÆC/330¡ÆC): %.2f\n', diffused_500_gradient/diffused_330_gradient);

%% Visualization (Identical to original)
figure('Name', 'Temperature Comparison: 330¡ÆC vs 500¡ÆC Interface Effects', 'Position', [100, 100, 1200, 600]);
...
hold off;
title('330¡ÆC: 2D vs 3D Interface', 'FontSize', 14);
...
hold off;
title('500¡ÆC: 2D vs 3D Interface', 'FontSize', 14);
xlabel('Position (nm)', 'FontSize', 12);
ylabel('Concentration of Ni', 'FontSize', 12);
legend('Location', 'best');
grid on;
